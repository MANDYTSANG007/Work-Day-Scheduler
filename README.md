# Work-Day-Scheduler
This Work Day Scheduler is modified using HTML, CSS, and JavaScript. This application's features are powered by jQuery incorporate with the Moment.js library for working with date and time.  
